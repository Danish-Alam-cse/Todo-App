       ...
       <div class="row">
           ...
           <div class="col-lg-5">
               <div class="card">
                ...
                <form action="save_new_list" method="post">
                    @csrf
                    <div class="mb-2">
                 ...
                 <div class="mb-2">
                     <textarea name="description" class="form-control" placeholder="Enter desvcription"></textarea>
                 ...
                 <div class="mb-2">
                     <input type="submit" value="save" class="float-end btn btn-success btn-lg">
